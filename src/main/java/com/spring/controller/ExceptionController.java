...
public class ExceptionController {
    ...
    @ExceptionHandler
    public static ResponseEntity<Object>orderdataException(OrderDataException orderDataException){
        LOGGER.error(orderDataException.toString(),orderDataException);
